    ...
    <AppContext.Provider value={userSettings}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName='BeforeLoginScreen'>
          ...
          <Stack.Screen name="MakeFolderBottomSheetScreen" component={MakeFolderBottomSheetScreen} options={{headerShown: false, presentation: 'transparentModal', gestureDirection: 'vertical', contentStyle:{backgroundColor:'transparent'}}}/>
          <Stack.Screen name="PlaceInfoBottomSheetScreen" component={PlaceInfoBottomSheetScreen} options={{headerShown: false, presentation: 'transparentModal', gestureDirection: 'vertical', contentStyle:{backgroundColor:'transparent'}}} />
          ...
          <Stack.Screen name="InviteFriendScreen" component={InviteFriendScreen} options={{headerShown: false, gestureEnabled: true, presentation: 'fullScreenModal'}}/>
        </Stack.Navigator>
      </NavigationContainer>
    </AppContext.Provider>
  )
