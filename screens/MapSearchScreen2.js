...
import { StyleSheet, Text, View, Button, Animated, TouchableOpacity, ScrollView, SafeAreaView, Image, TouchableHighlight } from 'react-native';
...
// formated address: route.formatted_address
    ...
    const [target, setTarget] = useState({lctn: { latitude: route.params.geometry.location.lat, longitude: route.params.geometry.location.lng }, latitudeDelta: 0.0016, longitudeDelta: 0.0012
    , name: route.params.name, address: route.params.formatted_address, id: route.params.place_id, bottomShown: route.params.bottomShown });   //현재 스크린에 나타나는 map의 중앙 좌표값
