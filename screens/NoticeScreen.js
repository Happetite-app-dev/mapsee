    ...
    useEffect(()=>{
        ...
        onValue(ref(db, '/notices/'+myUID), (snapshot)=>{
            snapshot.forEach((datasnapshot)=>{
                setNoticeList(prev=>[...prev, {key: datasnapshot.key, val:datasnapshot.val()}])
            })
        })
    },[])
        ...
        <SafeAreaView style={{backgroundColor: 'white'}}>
            ...
            <View style={{alignItems:'center', height: "90%"}}>
                ...
                <Snackbar
                    ...
                    style={{backgroundColor: '#545766', borderRadius: 8, fontSize: 12, lineHeight:16, letterSpacing: -0.5}}
                >
