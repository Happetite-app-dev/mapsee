    ...
    <AppContext.Provider value={userSettings}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName='BeforeLoginScreen'>
          ...
          <Stack.Screen options={{headerShown:false, presentation:'transparentModal'}} name="TutorialScreen" component={TutorialScreen} />
          <Stack.Screen name="Tabs" component={Tabs} options={{ headerShown: false, gestureEnabled: false}}/>
          <Stack.Screen name="MapSearchScreen1" component={MapSearchScreen1} options={{headerShown: false, gestureEnabled:false}}/>
          <Stack.Screen name="MapSearchScreen2" component={MapSearchScreen2} options={{headerShown: false, gestureEnabled:false}}/>
          <Stack.Screen name="MapSearchScreen3" component={MapSearchScreen3} options={{headerShown: false, gestureEnabled:false}}/>
